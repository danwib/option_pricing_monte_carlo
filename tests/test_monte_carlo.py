...
from src.monte_carlo import bs_call_price_delta, convergence_plot, delta_fd, euro_call_mc
...
def test_cv_reduces_variance_across_seeds():
    ...
    def estimates(method):
        return [
            euro_call_mc(100, 100, 0.01, 0.2, 1.0, n=30_000, seed=s, method=method)["price"]
            for s in seeds
        ]
